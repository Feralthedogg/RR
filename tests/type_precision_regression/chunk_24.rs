...
#[test]
fn base_direct_array_helpers_have_builtin_types() {
...
#[test]
fn base_direct_introspection_helpers_have_builtin_types() {
...
#[test]
fn base_direct_method_family_helpers_have_builtin_types() {
    let mut fn_ir = FnIR::new(
        "Sym_main".to_string(),
