...
#[test]
fn base_direct_cumulative_helpers_have_builtin_types() {
...
#[test]
fn base_direct_setter_helpers_have_builtin_types() {
    let mut fn_ir = FnIR::new(
        "Sym_main".to_string(),
        vec![
            "chars".to_string(),
...
#[test]
fn base_direct_command_encoding_helpers_have_builtin_types() {
    let mut fn_ir = FnIR::new(
        "Sym_main".to_string(),
