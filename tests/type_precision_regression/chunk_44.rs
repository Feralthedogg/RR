...
#[test]
fn stats_model_frame_from_updated_model_preserves_named_dataframe_schema() {
...
#[test]
fn stats_model_matrix_preserves_visible_row_count() {
    let mut fn_ir = FnIR::new("Sym_main".to_string(), vec![]);
    ...
    let formula_add_no_intercept_src = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("y ~ 0 + x + z".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let formula_add_zero_mid_src = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("y ~ x + 0 + z".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let formula_add_minus_one_src = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("y ~ -1 + x + z".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let formula_add_minus_one_suffix_src = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("y ~ x + z - 1".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let formula_add_minus_zero_suffix_src = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("y ~ x + z - 0".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let formula_add_restore_intercept_src = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("y ~ -1 + 1 + x + z".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let formula_add_remove_then_restore_src = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("y ~ x + z - 1 + 1".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
...
#[test]
fn methods_package_calls_have_direct_types() {
    let mut fn_ir = FnIR::new("Sym_main".to_string(), vec![]);
    ...
    let class_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("MethodDefinition".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    let generic_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("show".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    let any_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("ANY".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let missing_action = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("missing-action".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let arith_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("Arith".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let if_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("if".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let old_class_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("oldClass".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let probe_message = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("rr probe".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let env_ref_class_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("envRefClass".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let null_value = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Null),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let numeric_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("numeric".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    for vid in [
        ...
        assert_eq!(out.values[vid].value_ty, RR::typeck::TypeState::unknown());
