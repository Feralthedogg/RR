...
#[test]
fn datasets_package_table_loads_refine_known_numeric_table_shapes() {
...
#[test]
fn datasets_package_special_loads_refine_known_special_shapes() {
    let mut fn_ir = FnIR::new("Sym_main".to_string(), vec![]);
    ...
    let temp_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("temp".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let treatment_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("treatment".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    let conc_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("conc".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    ...
    let cov_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("cov".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    let center_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("center".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
    let n_obs_name = fn_ir.add_value(
        ValueKind::Const(RR::syntax::ast::Lit::Str("n.obs".to_string())),
        Span::dummy(),
        Facts::empty(),
        None,
    );
