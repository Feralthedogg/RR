...
#[test]
pub(crate) fn compiler_package_calls_have_direct_types() {
    let mut fn_ir = FnIR::new("Sym_main".to_string(), vec!["expr".to_string()]);
    fn_ir.param_ty_hints[0] = rr::compiler::internal::typeck::TypeState::unknown();
...
#[test]
pub(crate) fn stats_summary_lm_fields_have_direct_named_types() {
