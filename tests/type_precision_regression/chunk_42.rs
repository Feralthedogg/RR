...
#[test]
pub(crate) fn stats_utility_helpers_have_direct_types() {
...
#[test]
pub(crate) fn stats_model_misc_helpers_have_direct_types() {
    let mut fn_ir = FnIR::new("Sym_main".to_string(), vec![]);
...
#[test]
pub(crate) fn stats_ts_helpers_have_direct_types() {
    let mut fn_ir = FnIR::new("Sym_main".to_string(), vec![]);
