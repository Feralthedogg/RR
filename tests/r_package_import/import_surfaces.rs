...
#[test]
pub(crate) fn import_r_package_lowers_to_package_name_namespace_alias() {
...
#[test]
pub(crate) fn named_alias_and_default_r_imports_lower_to_namespaced_calls() {
    let rscript = match rscript_path() {
        Some(p) if rscript_available(&p) => p,
        _ => {
...
#[test]
pub(crate) fn namespace_r_import_lowers_to_namespaced_calls() {
    let rscript = match rscript_path() {
        Some(p) if rscript_available(&p) => p,
        _ => {
...
#[test]
pub(crate) fn tools_namespace_internal_members_emit_triple_colon_calls() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_stats_readr_tidyr_interop_avoids_opaque_and_hybrid() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_ggplot2_surface_accepts_geom_col_labs_and_theme_bw() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_readr_tsv_and_dplyr_left_join_avoid_opaque_and_hybrid() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_ggplot2_bar_with_inner_join_avoid_opaque_and_hybrid() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_ggplot2_facet_wrap_formula_shorthand_lowers_without_fallback() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_ggplot2_facet_wrap_multi_term_formula_lowers_without_fallback() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_ggplot2_facet_wrap_division_formula_lowers_without_fallback() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_ggplot2_facet_grid_formula_shorthand_lowers_without_fallback() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_stats_glm_model_formula_shorthand_lowers_without_fallback() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_stats_lm_model_formula_with_additive_rhs_lowers_without_fallback() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_stats_lm_model_formula_with_interaction_rhs_lowers_without_fallback() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_dplyr_full_and_right_join_avoid_opaque_and_hybrid() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_readr_delim_surface_avoids_opaque_and_hybrid() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_readr_rds_surface_avoids_opaque_and_hybrid() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_tidyr_separate_unite_and_dplyr_bind_rows_avoid_opaque_and_hybrid() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
...
#[test]
pub(crate) fn direct_dplyr_semi_and_anti_join_avoid_opaque_and_hybrid() {
    let root = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    let out_dir = root
        .join("target")
        .join("tests")
