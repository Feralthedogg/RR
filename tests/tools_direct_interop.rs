...
fn use_tools() -> char {
  ...
  let has_standard_package_names = base.any(tools_exports == "standard_package_names")
  let has_base_aliases_db = base.any(tools_exports == "base_aliases_db")
  let has_base_rdxrefs_db = base.any(tools_exports == "base_rdxrefs_db")
