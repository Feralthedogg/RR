...
fn use_tools() -> char {
  ...
  let std_pkgs = tools.standard_package_names()
  let base_aliases = tools.base_aliases_db()
  let base_rdxrefs = tools.base_rdxrefs_db()
  let cran_aliases = tools.CRAN_aliases_db()
  let cran_archive = tools.CRAN_archive_db()
  let cran_rdxrefs = tools.CRAN_rdxrefs_db()
  let cran_authors = tools.CRAN_authors_db()
  let cran_current = tools.CRAN_current_db()
  let check_results = tools.CRAN_check_results()
  let check_details = tools.CRAN_check_details()
  let check_issues = tools.CRAN_check_issues()
  ...
  print(length(std_pkgs))
  print(length(base_aliases))
  print(length(base_rdxrefs))
  print(length(cran_aliases))
  print(length(cran_archive))
  print(length(cran_rdxrefs))
  print(dim(cran_authors))
  print(dim(cran_current))
  print(dim(check_results))
  print(dim(check_details))
  print(dim(check_issues))
  print(dim(installed))
  print(length(deps))
  print(length(rd))
