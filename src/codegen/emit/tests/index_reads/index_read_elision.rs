...
#[test]
pub(crate) fn whole_range_call_map_slice_is_emitted_as_direct_vector_call() {
...
#[test]
pub(crate) fn loop_stable_known_full_end_allows_whole_range_call_map_fold() {
    let mut backend = RBackend::new();
    backend
        .loop_analysis
...
#[test]
pub(crate) fn whole_range_rr_index1_read_vec_call_elides_to_base_expr() {
    let mut backend = RBackend::new();
    backend
        .loop_analysis
        .known_full_end_exprs
...
#[test]
pub(crate) fn cube_index_scalar_read_elides_index_wrapper() {
...
#[test]
pub(crate) fn cube_index_scalar_read_reuses_bound_plain_symbol_for_index_expr() {
    let mut backend = RBackend::new();
    let values = vec![
        Value {
            id: 0,
...
pub(crate) fn wrap_index_scalar_read_elides_index_wrapper() {
    let backend = RBackend::new();
    let values = vec![
        Value {
            id: 0,
...
#[test]
pub(crate) fn direct_rr_index1_read_call_elides_when_index_is_safe() {
    let backend = RBackend::new();
    let values = vec![
        Value {
            id: 0,
...
#[test]
pub(crate) fn direct_rr_index1_read_call_elides_when_index_var_is_bound_to_safe_value() {
    let mut backend = RBackend::new();
    let values = vec![
        Value {
            id: 0,
...
#[test]
pub(crate) fn index1d_expr_elides_when_index_var_is_bound_to_safe_value() {
    let mut backend = RBackend::new();
    backend
        .loop_analysis
        .known_full_end_exprs
...
#[test]
pub(crate) fn index1d_expr_reuses_live_plain_symbol_alias_for_index_expr() {
    let mut backend = RBackend::new();
    let values = vec![
        Value {
            id: 0,
...
#[test]
pub(crate) fn active_scalar_loop_index_load_does_not_fold_to_seed_constant() {
    let mut backend = RBackend::new();
    backend
        .loop_analysis
