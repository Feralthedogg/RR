...
pub(crate) use self::search::cmd_search;

use self::args::{parse_registry_override_args, require_registry_root};
use self::channel::{
    cmd_registry_channel_clear, cmd_registry_channel_set, cmd_registry_channel_show,
};
use self::policy::{cmd_registry_policy_lint, cmd_registry_policy_rotate_key};
use self::read::{
