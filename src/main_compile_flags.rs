use RR::compiler::{
    CliLog, CompilerParallelConfig, CompilerParallelMode, OptLevel, ParallelBackend,
    ParallelConfig, ParallelMode,
};
use RR::typeck::{NativeBackend, TypeConfig, TypeMode};

#[path = "main_compile_flag_defs.rs"]
mod main_compile_flag_defs;

use self::main_compile_flag_defs::{
