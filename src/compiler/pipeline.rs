...
pub(crate) fn fn_emit_cache_salt() -> u64 {
    ...
    stable_hash_bytes(include_str!("pipeline.rs").as_bytes())
        ...
        ^ stable_hash_bytes(
            include_str!("../codegen/emit/rewrite/poly_index/generated_loop_steps.rs").as_bytes(),
        )
        ...
        ^ stable_hash_bytes(
            include_str!("../codegen/emit/rewrite/raw_text_helpers/symbol_rewrite.rs").as_bytes(),
        )
        ^ stable_hash_bytes(
            include_str!("../codegen/emit/rewrite/raw_text_helpers/function_spans.rs").as_bytes(),
        )
        ^ stable_hash_bytes(
        ...
        ^ stable_hash_bytes(
            include_str!("../codegen/emit/rewrite/scalar_alias/named_expr/two_use.rs").as_bytes(),
        )
        ^ stable_hash_bytes(
        ...
        ^ stable_hash_bytes(
            include_str!("../codegen/emit/rewrite/scalar_alias/index_alias/straight_line_reads.rs")
                .as_bytes(),
        )
        ...
        ^ stable_hash_bytes(
            include_str!("../codegen/emit/rewrite/temp_seed/seq_len_full_overwrite.rs").as_bytes(),
        )
        ^ stable_hash_bytes(
        ...
        ^ stable_hash_bytes(
            include_str!("../codegen/emit/rewrite/final_cleanup/loop_counter_alias.rs").as_bytes(),
        )
        ^ stable_hash_bytes(
...
pub(crate) fn compile_output_cache_salt() -> u64 {
    fn_emit_cache_salt()
        ...
        ^ stable_hash_bytes(include_str!("peephole/emitted_ir/passthrough/copy_vec.rs").as_bytes())
        ...
        ^ stable_hash_bytes(
            include_str!("peephole/emitted_ir/wrapper_cleanup/simple_expr_bundles.rs").as_bytes(),
        )
        ^ stable_hash_bytes(
        ...
        ^ stable_hash_bytes(include_str!("peephole/emitted_ir/exact_reuse/bundles.rs").as_bytes())
        ^ stable_hash_bytes(
        ...
        ^ stable_hash_bytes(include_str!("peephole/emitted_ir/exact_reuse/regions.rs").as_bytes())
        ^ stable_hash_bytes(
