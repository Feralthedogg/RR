...
pub(crate) struct RawRecordField {
...
pub(crate) fn rewrite_static_record_scalarization_lines(mut lines: Vec<String>) -> Vec<String> {
    ...
    while idx < lines.len() {
        ...
        for (use_idx, line) in lines.iter().enumerate().take(function_end).skip(idx + 1) {
...
pub(crate) fn parse_raw_record_list_expr(rhs: &str) -> Option<Vec<RawRecordField>> {
...
pub(crate) fn split_raw_record_field_arg(arg: &str) -> Option<(String, String)> {
    let mut depth = 0i32;
...
pub(crate) fn raw_record_field_expr_is_sroa_safe(expr: &str) -> bool {
...
pub(crate) fn raw_calls_are_sroa_safe(expr: &str) -> bool {
...
pub(crate) fn raw_callee_before_open(expr: &str, open: usize) -> Option<&str> {
...
pub(crate) fn raw_sroa_allowed_pure_call(callee: &str) -> bool {
    matches!(
        callee,
        "list"
            | "c"
...
pub(crate) fn raw_function_end_for_line(lines: &[String], idx: usize) -> Option<usize> {
...
pub(crate) fn collect_raw_symbols(lines: &[String]) -> FxHashSet<String> {
...
pub(crate) fn build_raw_record_field_temp_map(
    lhs: &str,
...
pub(crate) fn sanitize_raw_sroa_field_name(field: &str) -> String {
...
pub(crate) fn rewrite_raw_record_field_accesses(
    line: &str,
    base: &str,
...
pub(crate) fn raw_line_assigns_to_record_field(line: &str, base: &str) -> bool {
...
pub(crate) fn parse_raw_record_field_access_at(
    line: &str,
    idx: usize,
    base: &str,
) -> Option<(String, usize)> {
...
pub(crate) fn parse_direct_raw_record_field_access_at(
    line: &str,
    idx: usize,
    base: &str,
) -> Option<(String, usize)> {
...
pub(crate) fn parse_parenthesized_raw_record_field_access_at(
    line: &str,
    idx: usize,
    base: &str,
) -> Option<(String, usize)> {
...
pub(crate) fn raw_symbol_boundary_before(line: &str, idx: usize) -> bool {
    line[..idx]
        .chars()
        .next_back()
...
pub(crate) fn raw_ascii_whitespace_prefix_len(input: &str) -> usize {
    input
        .char_indices()
...
pub(crate) fn parse_raw_static_field_suffix(input: &str) -> Option<(String, usize)> {
...
pub(crate) fn rewrite_inline_literal_record_field_accesses(line: &str) -> String {
