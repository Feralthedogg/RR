...
fn vector_plan_label(plan: &VectorPlan) -> &'static str {
    match plan {
...
#[allow(clippy::too_many_arguments)]
fn materialize_vector_intrinsic(
    fn_ir: &mut FnIR,
    root: ValueId,
    op: IntrinsicOp,
    args: Vec<ValueId>,
