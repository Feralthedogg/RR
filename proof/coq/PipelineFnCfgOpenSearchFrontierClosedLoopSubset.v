...
Module RRPipelineFnCfgOpenSearchFrontierClosedLoopSubset.

Definition adaptive_open_search_frontier_trace : Type := list adaptive_summary.

Record src_fn_cfg_open_search_frontier_closed_loop_program : Type := {
  src_frontier_closed_rounds : list src_fn_cfg_open_search_frontier_adaptive_policy_program;
}.

Record mir_fn_cfg_open_search_frontier_closed_loop_program : Type := {
  mir_frontier_closed_rounds : list mir_fn_cfg_open_search_frontier_adaptive_policy_program;
}.

Record r_fn_cfg_open_search_frontier_closed_loop_program : Type := {
  r_frontier_closed_rounds : list r_fn_cfg_open_search_frontier_adaptive_policy_program;
}.

Definition lower_fn_cfg_open_search_frontier_closed_loop_program
    (p : src_fn_cfg_open_search_frontier_closed_loop_program)
    : mir_fn_cfg_open_search_frontier_closed_loop_program :=
  {| mir_frontier_closed_rounds :=
       List.map lower_fn_cfg_open_search_frontier_adaptive_policy_program (src_frontier_closed_rounds p) |}.

Definition emit_r_fn_cfg_open_search_frontier_closed_loop_program
    (p : mir_fn_cfg_open_search_frontier_closed_loop_program)
    : r_fn_cfg_open_search_frontier_closed_loop_program :=
  {| r_frontier_closed_rounds :=
       List.map emit_r_fn_cfg_open_search_frontier_adaptive_policy_program (mir_frontier_closed_rounds p) |}.

Definition eval_r_fn_cfg_open_search_frontier_closed_loop_program
    (p : r_fn_cfg_open_search_frontier_closed_loop_program) : adaptive_open_search_frontier_trace :=
  List.map eval_r_fn_cfg_open_search_frontier_adaptive_policy_program (r_frontier_closed_rounds p).

Definition r_open_search_frontier_closed_loop_witness
    (p : r_fn_cfg_open_search_frontier_closed_loop_program) : Prop :=
  forall round, In round (r_frontier_closed_rounds p) -> r_open_search_frontier_adaptive_policy_witness round.

Definition stable_fn_cfg_open_search_frontier_closed_loop_program :
    src_fn_cfg_open_search_frontier_closed_loop_program :=
  {| src_frontier_closed_rounds :=
       [stable_fn_cfg_open_search_frontier_adaptive_policy_program;
        stable_fn_cfg_open_search_frontier_adaptive_policy_program] |}.

Lemma stable_fn_cfg_open_search_frontier_closed_loop_program_meta_preserved :
  List.length
    (mir_frontier_closed_rounds
      (lower_fn_cfg_open_search_frontier_closed_loop_program
        stable_fn_cfg_open_search_frontier_closed_loop_program)) = 2%nat.
Proof.
  reflexivity.
Qed.

Lemma stable_fn_cfg_open_search_frontier_closed_loop_program_eval_preserved :
  eval_r_fn_cfg_open_search_frontier_closed_loop_program
    (emit_r_fn_cfg_open_search_frontier_closed_loop_program
      (lower_fn_cfg_open_search_frontier_closed_loop_program
        stable_fn_cfg_open_search_frontier_closed_loop_program)) =
    [stable_closed_loop_summary; stable_closed_loop_summary].
Proof.
  reflexivity.
Qed.

Lemma stable_fn_cfg_open_search_frontier_closed_loop_program_preserved :
  r_open_search_frontier_closed_loop_witness
    (emit_r_fn_cfg_open_search_frontier_closed_loop_program
      (lower_fn_cfg_open_search_frontier_closed_loop_program
        stable_fn_cfg_open_search_frontier_closed_loop_program)).
Proof.
  intros round hIn.
  simpl in hIn.
  destruct hIn as [hIn | [hIn | []]]; subst round.
  - exact stable_fn_cfg_open_search_frontier_adaptive_policy_program_preserved.
  - exact stable_fn_cfg_open_search_frontier_adaptive_policy_program_preserved.
Qed.

End RRPipelineFnCfgOpenSearchFrontierClosedLoopSubset.
