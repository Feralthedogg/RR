...
Module RRPipelineFnCfgOpenSearchFrontierPolicySubset.

Definition open_search_frontier_priority_rule : Type := (nat * nat)%type.

Definition rewrite_open_search_frontier_priority
    (rules : list open_search_frontier_priority_rule) (prio : nat) : nat :=
  match List.find (fun entry => Nat.eqb (fst entry) prio) rules with
  | Some (_, new_prio) => new_prio
  | None => prio
  end.

Definition rewrite_open_search_frontier_rounds
    (rules : list open_search_frontier_priority_rule)
    (rounds : list open_search_frontier_priority_round)
    : list open_search_frontier_priority_round :=
  List.map (fun '(prio, updates) => (rewrite_open_search_frontier_priority rules prio, updates)) rounds.

Record src_fn_cfg_open_search_frontier_policy_program : Type := {
  src_frontier_policy_prio_prog : src_fn_cfg_open_search_frontier_priority_program;
  src_frontier_policy_rules : list open_search_frontier_priority_rule;
  src_frontier_policy_normalized_rounds : list open_search_frontier_priority_round;
}.

Record mir_fn_cfg_open_search_frontier_policy_program : Type := {
  mir_frontier_policy_prio_prog : mir_fn_cfg_open_search_frontier_priority_program;
  mir_frontier_policy_rules : list open_search_frontier_priority_rule;
  mir_frontier_policy_normalized_rounds : list open_search_frontier_priority_round;
}.

Record r_fn_cfg_open_search_frontier_policy_program : Type := {
  r_frontier_policy_prio_prog : r_fn_cfg_open_search_frontier_priority_program;
  r_frontier_policy_rules : list open_search_frontier_priority_rule;
  r_frontier_policy_normalized_rounds : list open_search_frontier_priority_round;
}.

Definition r_open_search_frontier_policy_witness
    (p : r_fn_cfg_open_search_frontier_policy_program) : Prop :=
  r_open_search_frontier_priority_witness (r_frontier_policy_prio_prog p) /\
  r_frontier_policy_normalized_rounds p =
    rewrite_open_search_frontier_rounds
      (r_frontier_policy_rules p) (r_frontier_prio_rounds (r_frontier_policy_prio_prog p)).

Definition lower_fn_cfg_open_search_frontier_policy_program
    (p : src_fn_cfg_open_search_frontier_policy_program)
    : mir_fn_cfg_open_search_frontier_policy_program :=
  {| mir_frontier_policy_prio_prog :=
       lower_fn_cfg_open_search_frontier_priority_program (src_frontier_policy_prio_prog p);
     mir_frontier_policy_rules := src_frontier_policy_rules p;
     mir_frontier_policy_normalized_rounds := src_frontier_policy_normalized_rounds p |}.

Definition emit_r_fn_cfg_open_search_frontier_policy_program
    (p : mir_fn_cfg_open_search_frontier_policy_program)
    : r_fn_cfg_open_search_frontier_policy_program :=
  {| r_frontier_policy_prio_prog :=
       emit_r_fn_cfg_open_search_frontier_priority_program (mir_frontier_policy_prio_prog p);
     r_frontier_policy_rules := mir_frontier_policy_rules p;
     r_frontier_policy_normalized_rounds := mir_frontier_policy_normalized_rounds p |}.

Definition eval_r_fn_cfg_open_search_frontier_policy_program
    (p : r_fn_cfg_open_search_frontier_policy_program) : adaptive_summary :=
  eval_r_fn_cfg_open_search_frontier_priority_program (r_frontier_policy_prio_prog p).

Definition stable_fn_cfg_open_search_frontier_policy_program :
    src_fn_cfg_open_search_frontier_policy_program :=
  {| src_frontier_policy_prio_prog := stable_fn_cfg_open_search_frontier_priority_program;
     src_frontier_policy_rules := [(5%nat, 3%nat); (3%nat, 1%nat)];
     src_frontier_policy_normalized_rounds :=
       [(3%nat, [stable_closed_loop_summary; []]); (1%nat, [stable_closed_loop_summary])] |}.

Lemma stable_fn_cfg_open_search_frontier_policy_program_meta_preserved :
  List.length
            ...
            (mir_dyn_frontier_prog
              (mir_open_sched_dyn_prog
                (mir_frontier_prio_sched_prog
                  (mir_frontier_policy_prio_prog
                    (lower_fn_cfg_open_search_frontier_policy_program
                      stable_fn_cfg_open_search_frontier_policy_program))))))))) = 2%nat /\
  mir_frontier_policy_rules
    (lower_fn_cfg_open_search_frontier_policy_program
      stable_fn_cfg_open_search_frontier_policy_program) =
    [(5%nat, 3%nat); (3%nat, 1%nat)] /\
  mir_frontier_policy_normalized_rounds
    (lower_fn_cfg_open_search_frontier_policy_program
      stable_fn_cfg_open_search_frontier_policy_program) =
    [(3%nat, [stable_closed_loop_summary; []]); (1%nat, [stable_closed_loop_summary])].
Proof.
...
Lemma stable_fn_cfg_open_search_frontier_policy_program_eval_preserved :
  eval_r_fn_cfg_open_search_frontier_policy_program
    (emit_r_fn_cfg_open_search_frontier_policy_program
      (lower_fn_cfg_open_search_frontier_policy_program
        stable_fn_cfg_open_search_frontier_policy_program)) =
...
Lemma stable_fn_cfg_open_search_frontier_policy_program_preserved :
  r_open_search_frontier_policy_witness
    (emit_r_fn_cfg_open_search_frontier_policy_program
      (lower_fn_cfg_open_search_frontier_policy_program
        stable_fn_cfg_open_search_frontier_policy_program)).
Proof.
  split.
  - exact stable_fn_cfg_open_search_frontier_priority_program_preserved.
  - reflexivity.
Qed.

End RRPipelineFnCfgOpenSearchFrontierPolicySubset.
