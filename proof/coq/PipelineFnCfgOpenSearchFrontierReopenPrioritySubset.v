...
Module RRPipelineFnCfgOpenSearchFrontierReopenPrioritySubset.

Definition open_search_frontier_reopen_priority_round : Type :=
  (nat * list adaptive_summary)%type.

Record src_fn_cfg_open_search_frontier_reopen_priority_program : Type := {
  src_reopen_prio_sched_prog : src_fn_cfg_open_search_frontier_reopen_scheduler_program;
  src_reopen_prio_tail : list open_search_frontier_reopen_priority_round;
  src_reopen_prio_rounds : list open_search_frontier_reopen_priority_round;
}.

Record mir_fn_cfg_open_search_frontier_reopen_priority_program : Type := {
  mir_reopen_prio_sched_prog : mir_fn_cfg_open_search_frontier_reopen_scheduler_program;
  mir_reopen_prio_tail : list open_search_frontier_reopen_priority_round;
  mir_reopen_prio_rounds : list open_search_frontier_reopen_priority_round;
}.

Record r_fn_cfg_open_search_frontier_reopen_priority_program : Type := {
  r_reopen_prio_sched_prog : r_fn_cfg_open_search_frontier_reopen_scheduler_program;
  r_reopen_prio_tail : list open_search_frontier_reopen_priority_round;
  r_reopen_prio_rounds : list open_search_frontier_reopen_priority_round;
}.

Definition r_open_search_frontier_reopen_priority_witness
    (p : r_fn_cfg_open_search_frontier_reopen_priority_program) : Prop :=
  r_open_search_frontier_reopen_scheduler_witness (r_reopen_prio_sched_prog p) /\
  r_reopen_prio_rounds p =
    (5%nat, r_reopen_dyn_next_frontier (r_reopen_sched_dyn_prog (r_reopen_prio_sched_prog p))) ::
      r_reopen_prio_tail p /\
  In (r_open_frontier_halt_selected
        (r_open_reopen_halt_prog
          (r_reopen_dyn_prog (r_reopen_sched_dyn_prog (r_reopen_prio_sched_prog p)))))
    (r_reopen_dyn_next_frontier (r_reopen_sched_dyn_prog (r_reopen_prio_sched_prog p))).

Definition lower_fn_cfg_open_search_frontier_reopen_priority_program
    (p : src_fn_cfg_open_search_frontier_reopen_priority_program)
    : mir_fn_cfg_open_search_frontier_reopen_priority_program :=
  {| mir_reopen_prio_sched_prog :=
       lower_fn_cfg_open_search_frontier_reopen_scheduler_program (src_reopen_prio_sched_prog p);
     mir_reopen_prio_tail := src_reopen_prio_tail p;
     mir_reopen_prio_rounds := src_reopen_prio_rounds p |}.

Definition emit_r_fn_cfg_open_search_frontier_reopen_priority_program
    (p : mir_fn_cfg_open_search_frontier_reopen_priority_program)
    : r_fn_cfg_open_search_frontier_reopen_priority_program :=
  {| r_reopen_prio_sched_prog :=
       emit_r_fn_cfg_open_search_frontier_reopen_scheduler_program (mir_reopen_prio_sched_prog p);
     r_reopen_prio_tail := mir_reopen_prio_tail p;
     r_reopen_prio_rounds := mir_reopen_prio_rounds p |}.

Definition eval_r_fn_cfg_open_search_frontier_reopen_priority_program
    (p : r_fn_cfg_open_search_frontier_reopen_priority_program) : adaptive_summary :=
  eval_r_fn_cfg_open_search_frontier_reopen_scheduler_program (r_reopen_prio_sched_prog p).

Definition stable_fn_cfg_open_search_frontier_reopen_priority_program :
    src_fn_cfg_open_search_frontier_reopen_priority_program :=
  {| src_reopen_prio_sched_prog := stable_fn_cfg_open_search_frontier_reopen_scheduler_program;
     src_reopen_prio_tail := [(3%nat, [stable_closed_loop_summary])];
     src_reopen_prio_rounds :=
       [(5%nat, [stable_closed_loop_summary; []]); (3%nat, [stable_closed_loop_summary])] |}.

Lemma stable_fn_cfg_open_search_frontier_reopen_priority_program_meta_preserved :
  List.length
              ...
              (mir_reopen_sched_dyn_prog
                (mir_reopen_prio_sched_prog
                  (lower_fn_cfg_open_search_frontier_reopen_priority_program
                    stable_fn_cfg_open_search_frontier_reopen_priority_program)))))))) = 2%nat /\
  mir_reopen_prio_tail
    (lower_fn_cfg_open_search_frontier_reopen_priority_program
      stable_fn_cfg_open_search_frontier_reopen_priority_program) =
    [(3%nat, [stable_closed_loop_summary])] /\
  mir_reopen_prio_rounds
    (lower_fn_cfg_open_search_frontier_reopen_priority_program
      stable_fn_cfg_open_search_frontier_reopen_priority_program) =
    [(5%nat, [stable_closed_loop_summary; []]); (3%nat, [stable_closed_loop_summary])].
Proof.
...
Lemma stable_fn_cfg_open_search_frontier_reopen_priority_program_eval_preserved :
...
Lemma stable_fn_cfg_open_search_frontier_reopen_priority_program_preserved :
  r_open_search_frontier_reopen_priority_witness
    (emit_r_fn_cfg_open_search_frontier_reopen_priority_program
      (lower_fn_cfg_open_search_frontier_reopen_priority_program
        stable_fn_cfg_open_search_frontier_reopen_priority_program)).
Proof.
  split.
  - exact stable_fn_cfg_open_search_frontier_reopen_scheduler_program_preserved.
  - split.
    + reflexivity.
    + simpl. tauto.
Qed.

End RRPipelineFnCfgOpenSearchFrontierReopenPrioritySubset.
