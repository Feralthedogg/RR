...
Module RRPipelineFnCfgOpenSearchFrontierReopenDynamicSubset.

Record src_fn_cfg_open_search_frontier_reopen_dynamic_program : Type := {
  src_reopen_dyn_prog : src_fn_cfg_open_search_frontier_reopen_program;
  src_reopen_dyn_discovered : list adaptive_summary;
  src_reopen_dyn_next_frontier : list adaptive_summary;
}.

Record mir_fn_cfg_open_search_frontier_reopen_dynamic_program : Type := {
  mir_reopen_dyn_prog : mir_fn_cfg_open_search_frontier_reopen_program;
  mir_reopen_dyn_discovered : list adaptive_summary;
  mir_reopen_dyn_next_frontier : list adaptive_summary;
}.

Record r_fn_cfg_open_search_frontier_reopen_dynamic_program : Type := {
  r_reopen_dyn_prog : r_fn_cfg_open_search_frontier_reopen_program;
  r_reopen_dyn_discovered : list adaptive_summary;
  r_reopen_dyn_next_frontier : list adaptive_summary;
}.

Definition r_open_search_frontier_reopen_dynamic_witness
    (p : r_fn_cfg_open_search_frontier_reopen_dynamic_program) : Prop :=
  r_open_search_frontier_reopen_witness (r_reopen_dyn_prog p) /\
  r_reopen_dyn_next_frontier p =
    List.app (r_open_reopen_frontier (r_reopen_dyn_prog p)) (r_reopen_dyn_discovered p) /\
  In (r_open_frontier_halt_selected (r_open_reopen_halt_prog (r_reopen_dyn_prog p)))
    (r_reopen_dyn_next_frontier p).

Definition lower_fn_cfg_open_search_frontier_reopen_dynamic_program
    (p : src_fn_cfg_open_search_frontier_reopen_dynamic_program)
    : mir_fn_cfg_open_search_frontier_reopen_dynamic_program :=
  {| mir_reopen_dyn_prog := lower_fn_cfg_open_search_frontier_reopen_program (src_reopen_dyn_prog p);
     mir_reopen_dyn_discovered := src_reopen_dyn_discovered p;
     mir_reopen_dyn_next_frontier := src_reopen_dyn_next_frontier p |}.

Definition emit_r_fn_cfg_open_search_frontier_reopen_dynamic_program
    (p : mir_fn_cfg_open_search_frontier_reopen_dynamic_program)
    : r_fn_cfg_open_search_frontier_reopen_dynamic_program :=
  {| r_reopen_dyn_prog := emit_r_fn_cfg_open_search_frontier_reopen_program (mir_reopen_dyn_prog p);
     r_reopen_dyn_discovered := mir_reopen_dyn_discovered p;
     r_reopen_dyn_next_frontier := mir_reopen_dyn_next_frontier p |}.

Definition eval_r_fn_cfg_open_search_frontier_reopen_dynamic_program
    (p : r_fn_cfg_open_search_frontier_reopen_dynamic_program) : adaptive_summary :=
  eval_r_fn_cfg_open_search_frontier_reopen_program (r_reopen_dyn_prog p).

Definition stable_fn_cfg_open_search_frontier_reopen_dynamic_program :
    src_fn_cfg_open_search_frontier_reopen_dynamic_program :=
  {| src_reopen_dyn_prog := stable_fn_cfg_open_search_frontier_reopen_program;
     src_reopen_dyn_discovered := [[]];
     src_reopen_dyn_next_frontier := [stable_closed_loop_summary; []] |}.

Lemma stable_fn_cfg_open_search_frontier_reopen_dynamic_program_meta_preserved :
  List.length
          ...
          (mir_open_reopen_halt_prog
            (mir_reopen_dyn_prog
              (lower_fn_cfg_open_search_frontier_reopen_dynamic_program
                stable_fn_cfg_open_search_frontier_reopen_dynamic_program)))))) = 2%nat /\
  mir_reopen_dyn_discovered
    (lower_fn_cfg_open_search_frontier_reopen_dynamic_program
      stable_fn_cfg_open_search_frontier_reopen_dynamic_program) = [[]] /\
  mir_reopen_dyn_next_frontier
    (lower_fn_cfg_open_search_frontier_reopen_dynamic_program
      stable_fn_cfg_open_search_frontier_reopen_dynamic_program) =
...
Lemma stable_fn_cfg_open_search_frontier_reopen_dynamic_program_eval_preserved :
...
Lemma stable_fn_cfg_open_search_frontier_reopen_dynamic_program_preserved :
  r_open_search_frontier_reopen_dynamic_witness
    (emit_r_fn_cfg_open_search_frontier_reopen_dynamic_program
      (lower_fn_cfg_open_search_frontier_reopen_dynamic_program
        stable_fn_cfg_open_search_frontier_reopen_dynamic_program)).
Proof.
  split.
  - exact stable_fn_cfg_open_search_frontier_reopen_program_preserved.
  - split.
    + reflexivity.
    + simpl. tauto.
Qed.

End RRPipelineFnCfgOpenSearchFrontierReopenDynamicSubset.
